...
int feedId = Integer.parseInt(feedIdParam);
            ...
            <div class="modal-content" style="background-color: #585757;">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal"  id="closeModalButton" aria-label="Close" >
		       		...
		       		<form:form id="reportDmForm" action="${pageContext.request.contextPath}/report/insertReportFeed" method="post">
						    <div class="modal-body"> 
						        <div class="card-footer text-muted d-flex justify-content-start align-items-center p-3" style="flex-wrap: wrap;">
						            <div class="input-group mb-3">
						                <input type="number" id="feedId" name="feedId" class="form-control" placeholder="신고할 DM 아이디"  value="<%= feedId %>" aria-label="Partner's ID" aria-describedby="button-addon2" required />
