...
<div class="d-flex justify-content-center align-items-center" style="min-width: 100vw;">
    ...
    <form:form action="${pageContext.request.contextPath}/member/memberLogin.do"
        ...
        <fieldset style="color : rgba(120,194,173);">
            <legend style="font-weight: bold; font-size : 50px; text-align: center;font-family: 'DungGeunMo';">Login</legend>
            <div class="form-group row w-100 d-flex flex-column justify-content-center">
                <div>
                    <label for="username" class="col-sm-2 col-form-label">ID</label>
                    <div class="form-group col-sm-15">
                        <input type="text" value="user1" name="username" id="username" placeholder="Input"
                               class="form-control"/>
                    </div>
                </div>
                <div>
            ...
            <div class="d-flex justify-content-center align-items-center" style="margin-top:20px;">
                <button type="submit" id="login" class="btn btn-primary" style="border-radius: 50px; width : 20vw;">
                    로그인
                </button>
            </div>
        </fieldset>
...
<div class="d-flex justify-content-center align-items-center mt-4" style="margin-top : 30px;">
...
<div class="sns-icon d-flex flex-column justify-content-center align-items-center" style="margin-top : 30px;">
    <p>간편 로그인을 이용하세요</p>
    <div class="d-flex flex-row">
    <a href="${pageContext.request.contextPath}/oauth/google/login"><img  src="${pageContext.request.contextPath}/resources/images/google_login.png"></a>
    &nbsp;
...
<div class="d-flex flex-column justify-content-center align-items-center mt-5">
    ...
    <button type="submit" id="memberCreate" class="btn btn-primary" style="border-radius: 50px; width : 20vw;"
            onclick="location.href='${pageContext.request.contextPath}/member/memberCreate.do';">
        회원가입
    </button>
</div>
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="mail-check-box mt-2">
                        <input class="form-control mail-check-input" id="mailAuth" placeholder="인증번호 6자리를 입력해주세요!"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div id="modalContent1">
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="mail-check-box mt-2">
                            <input class="form-control mail-check-input" id="mailAuth2" placeholder="인증번호 6자리를 입력해주세요!"
                                   disabled="disabled" maxlength="6">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" value="" class="form-control" id="usernameId" name="username"
                                   placeholder="아이디 입력">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary close-modal" id="close1" data-bs-dismiss="modal">
                        Close
                    </button>
                </div>
            </div>
            <div id="modalContent2">
                <div class="column">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="password" value="" class="form-control" id="password2" name="password"
                                   placeholder="6~12글자의 영소문자+ 숫자 + 특수문자(!,@,#)포함">
                            <div class="valid-feedback" id="pwdValid">입력하신 비밀번호는 사용 가능합니다.</div>
                            <div class="invalid-feedback" id="pwdInvalid">비밀번호는 6~12자, 1개 이상의 숫자와 특수문자 ! @ # 중 하나를
                                포함해야합니다.
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary searchId" onclick="resetPassword()">Reset Password
                    </button>
                    <button type="button" class="btn btn-secondary close-modal" id="close2" data-bs-dismiss="modal">
                        Close
                    </button>
                </div>
            </div>
