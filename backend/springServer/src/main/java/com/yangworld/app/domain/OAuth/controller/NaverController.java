...
import com.yangworld.app.domain.OAuth.service.NaverService;
...
//        String authorizeUri = naverService.getAuthorizeUri();
//        return ResponseEntity.ok(authorizeUri);
//    }

    @PostMapping("")
    public ResponseEntity<?> naverhandler(@RequestBody NaverDto naverDto) {
        log.info("naverDto = {}", naverDto);
        switch (naverDto.getProvider()) {
            case "naver":
                String[] result = naverService.naver(naverDto);
